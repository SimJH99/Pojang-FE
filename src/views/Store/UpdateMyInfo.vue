<template>
    <div class="min-h-screen flex bg-gray-100">
      ...
      <!-- 오른쪽 컨텐츠 영역 -->
      <div class="w-5/6 p-8">
        <h2 class="text-3xl font-semibold mb-6 text-gray-800">사장님 프로필 수정</h2>
        <form @submit.prevent="submitProfile">
          <div class="bg-white p-4 rounded-md">
            ...
            <button type="submit" class="bg-black text-white px-4 py-2 rounded-md mt-4 mr-3 hover:bg-gray-900 focus:outline-none focus:shadow-outline-gray active:bg-gray-800">
              저장
            </button>
